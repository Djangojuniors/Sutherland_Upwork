...
def detect_tables(pdf_file, pg):
    ...
    for i, db in enumerate(output_camelot):
        db.to_csv(pdf_file[:-4] + "-" + str(pg) + "-table-" + str(i) + ".csv")


# %%
# if __name__ == '__main__':
#     parser = argparse.ArgumentParser()
#     parser.add_argument("--pdf_path", type=str, default="HLILTA01.pdf", help="PDF path located in pdfs folder")
#     parser.add_argument("--page", type=int, default=4, help="Page to parse")
